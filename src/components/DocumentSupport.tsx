...
import { Upload, FileText, CheckCircle, AlertCircle, Download, Eye, Trash2 } from "lucide-react";
...
const DocumentSupport = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto p-6">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-green-800 mb-2">Document Management</h2>
        <p className="text-green-600">Upload and manage your application documents</p>
      </div>
